...
namespace StealFocus.TfsExtensions.Tests.Workflow.Activities
{
    using System;
    ...
    using UpdateBuildNumber = StealFocus.TfsExtensions.Workflow.Activities.UpdateBuildNumber;
    ...
    public class UpdateBuildNumberTests
    {
        ...
        /// <summary>
        /// Tests the component initializing the version correctly.
        /// </summary>
        [TestMethod]
